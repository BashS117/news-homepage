...
function Header  () {
  ...
  return (
    <header className='flex items-center justify-between sm:w-auto relative'>
      ...
      <svg onClick={openNavMenu} className='cursor-pointer lg:hidden xl:hidden md:hidden absolute right-0' width="40" height="17" xmlns="http://www.w3.org/2000/svg"><g fill="#00001A" fill-rule="evenodd"><path d="M0 0h40v3H0zM0 7h40v3H0zM0 14h40v3H0z"/><path d="M0 0h40v3H0z"/></g></svg>
    ...
    <nav className={` ${isNavOpen ? '' : 'sm:hidden'} z-20 `}>
      ...
      className='lg:hidden xl:hidden md:hidden sm:mb-[90px] sm:mt-[42px] sm:mr-5'
       width="32" height="31" xmlns="http://www.w3.org/2000/svg"><g fill="#00001A" fill-rule="evenodd"><path d="m2.919.297 28.284 28.284-2.122 2.122L.797 2.419z"/><path d="M.797 28.581 29.081.297l2.122 2.122L2.919 30.703z"/></g></svg>
